               ...
               <div class="card-body">
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-primary" ID="LinkButton4" runat="server" Height="38px" OnClick="LinkButton4_Click1" Width="45px"><i class="fas fa-check-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-success mr-1" ID="LinkButton1" runat="server" Height="38px" OnClick="LinkButton1_Click1" Width="38px"><i class="fas fa-check-circle"></i></asp:LinkButton>
                              <asp:LinkButton class="btn btn-warning mr-1" ID="LinkButton2" runat="server" Height="38px" OnClick="LinkButton2_Click1" Width="38px"><i class="far fa-pause-circle"></i></asp:LinkButton>
                              <asp:LinkButton class="btn btn-danger mr-1" ID="LinkButton3" runat="server" OnClick="LinkButton3_Click" Height="38px" Width="38px"><i class="fas fa-times-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-6 mx-auto">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" runat="server" Text="Delete User Permanently" Height="50px" OnClick="Button2_Click1" />
                     </div>
                  </div>
               </div>
            </div>
