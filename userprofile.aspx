            ...
            <div class="card">
               <div class="card-body">
                     ...
                     <div class="col">
                        <center>
                         ...
                         <span>Account Status - </span>
                           <asp:Label class="badge badge-pill badge-info" ID="Label1" runat="server" Text="Your status" BackColor="#0099CC"></asp:Label>
                        </center>
                     </div>
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                          <span class="badge rounded-pill bg-info text-dark">Login Creditentials</span>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <div class="form-group col-md-8 max-auto ">

                              <asp:Button class="btn btn-primary btn-block btn-lg" ID="Button1" runat="server" Text="Update" OnClick="Button1_Click" />
                           </div>
                        </center>
                     </div>
                      <a class=" text-decoration-none" href="homepage.aspx"><< Back to Home</a><br><br>
                  </div>
               </div>
            </div>
